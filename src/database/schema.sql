...
--   - CASCADE constraints are properly configured for data integrity
-- =============================================================
...
CREATE TABLE IF NOT EXISTS tasks (
    ...
    related_ticket_id VARCHAR(20),       -- FK to tickets (nullable, for linking to a ticket)
    is_active BOOLEAN DEFAULT true,      -- Soft delete/active flag
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
ALTER TABLE users DROP INDEX IF EXISTS idx_users_id;
ALTER TABLE departments DROP INDEX IF EXISTS idx_departments_id;
ALTER TABLE tickets DROP INDEX IF EXISTS idx_tickets_id;
ALTER TABLE tasks DROP INDEX IF EXISTS idx_tasks_id;
ALTER TABLE comments DROP INDEX IF EXISTS idx_comments_id;
ALTER TABLE notifications DROP INDEX IF EXISTS idx_notifications_id;
ALTER TABLE file_attachments DROP INDEX IF EXISTS idx_file_attachments_id;
ALTER TABLE user_sessions DROP INDEX IF EXISTS idx_user_sessions_id;
ALTER TABLE users DROP INDEX IF EXISTS idx_users_department;
ALTER TABLE users DROP INDEX IF EXISTS idx_users_role;
ALTER TABLE users DROP INDEX IF EXISTS idx_users_role_department;
ALTER TABLE tickets DROP INDEX IF EXISTS idx_tickets_status;
ALTER TABLE tickets DROP INDEX IF EXISTS idx_tickets_priority;
...
ALTER TABLE user_sessions DROP INDEX IF EXISTS idx_user_sessions_expires;
ALTER TABLE tickets DROP INDEX IF EXISTS idx_tickets_due_date;
ALTER TABLE tasks DROP INDEX IF EXISTS idx_tasks_due_date;
...
VALUES ('John', 'Doe', 'john@example.com', 'hashed_password', 'employee');
